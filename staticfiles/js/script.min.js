...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".gallery-thumb, .video-thumb").forEach(el => {
...
// Make the "no results" alert disappear after 5 seconds
document.addEventListener("DOMContentLoaded", function () {
  const alertBox = document.getElementById("no-results");
  if (alertBox) {
    setTimeout(() => {
